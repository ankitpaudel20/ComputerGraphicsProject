namespace glm {
    ...
    GLM_FUNC_QUALIFIER qua <T, Q> mix(qua < T, Q >
    const& x,
    qua <T, Q> const &y, T
    a) {
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER qua <T, Q> lerp(qua < T, Q >
const& x,
qua <T, Q> const &y, T
a)
{
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER qua <T, Q> slerp(qua < T, Q >
const& x,
qua <T, Q> const &y, T
a)
{
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER qua <T, Q> conjugate(qua < T, Q >
const& q)
{
return
qua<T, Q>(q
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER qua <T, Q> inverse(qua < T, Q >
const& q)
{
return
conjugate(q)
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec<4, bool, Q> isnan(qua < T, Q >
const& q)
{
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec<4, bool, Q> isinf(qua < T, Q >
const& q)
{
